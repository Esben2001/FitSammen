...
//                    Assert.Equal("Main St", loc.StresetName);
//                    Assert.Equal(123, loc.HouseNumber);
//                    Assert.Equal(1000, loc.ZipcodeNumber);
//                    Assert.Equal("Aalborg", loc.CityName);
//                    Assert.Equal("Danmark", loc.CountryName);
//                },
//                loc =>
//                {
...
//                    Assert.Equal(2000, loc.ZipcodeNumber);
//                    Assert.Equal("Copenhagen", loc.CityName);
//                    Assert.Equal("Danmark", loc.CountryName);
//                });
//        }
//        [Fact]
